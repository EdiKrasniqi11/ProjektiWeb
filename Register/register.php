...
<body>
    ...
    <div id="korniza">
        <form class="box" action="#" method="post">
            ...
            <div class="nameClass">
                <input type="text" required autocomplete="off" id="emri" placeholder="Name">
                <input type="text" required autocomplete="off" id="mbiemri" placeholder="Surname">
            </div>
            ...
            <input type="password" required autocomplete="off" id="confirmPassword" placeholder="Confirm Password">
            <p id="showId" onclick="showPass()">Show Password</p>
            <button type="submit" id="loginButton" onclick="return validimi()">
